       ...
       "elements": [
         {
           "key": "sales-hero",
           "type": "section",
           "classes": ["bg-primary", "px-4", "py-14", "font-sans", "text-primary-foreground", "antialiased", "md:py-24"],
           "children": [
             {
               "key": "sales-hero-wrap",
               "type": "container",
               "classes": ["mx-auto", "grid", "max-w-6xl", "items-center", "gap-10", "md:grid-cols-[minmax(0,1fr)_minmax(340px,0.9fr)]"],
               "children": [
                 {
                   "key": "sales-copy",
                   "type": "container",
                   ...
                   "children": [
                     {"key": "sales-kicker", "type": "text", "tag": "p", "text": "Course launch operating system", "classes": ["text-sm", "font-bold", "text-primary-foreground"], "children": []},
                     {"key": "sales-headline", "type": "heading", "tag": "h1", "text": "Turn your expertise into a course funnel that can sell this week", "classes": ["text-4xl", "font-black", "leading-tight", "tracking-tight", "text-primary-foreground", "md:text-6xl"], "children": []},
                     {"key": "sales-subhead", "type": "text", "tag": "p", "text": "Package the Offer, publish the sales Page, and launch Checkout with a revenue path you can see instead of a launch plan you hope works.", "classes": ["max-w-[65ch]", "text-lg", "leading-relaxed", "text-primary-foreground", "md:text-xl"], "children": []},
                     {"key": "sales-cta", "type": "button", "tag": "a", "attributes": {"href": "#checkout"}, "text": "Enroll now", "classes": ["inline-flex", "h-14", "w-full", "items-center", "justify-center", "rounded-2xl", "bg-background", "px-8", "font-bold", "text-foreground", "shadow-elevated", "md:w-fit"], "children": []},
                     {"key": "sales-note", "type": "text", "tag": "p", "text": "Includes templates, launch calendar, and the first revenue dashboard.", "classes": ["text-sm", "leading-relaxed", "text-primary-foreground"], "children": []}
                   ]
                 },
                 {
                   ...
                   "children": [
                     {"key": "sales-snapshot-title", "type": "heading", "tag": "h2", "text": "Course Launch OS", "classes": ["text-2xl", "font-black", "tracking-tight", "text-foreground"], "children": []},
                     {"key": "sales-snapshot-copy", "type": "text", "tag": "p", "text": "The complete sales path: promise, Offer, Checkout, delivery, and the revenue review that tells you what to improve next.", "classes": ["mt-3", "text-base", "leading-relaxed", "text-foreground"], "children": []},
         ...
         },
         {
           "key": "sales-problem",
           "type": "section",
           "classes": ["bg-background", "px-4", "py-14", "font-sans", "text-foreground", "md:py-20"],
           "children": [
             {"key": "sales-problem-wrap", "type": "container", "classes": ["mx-auto", "grid", "max-w-6xl", "gap-8", "items-start", "md:grid-cols-[0.8fr_1.2fr]"], "children": [
               {"key": "problem-heading", "type": "heading", "tag": "h2", "text": "The painful part is not making the course. It is knowing what has to sell it.", "classes": ["text-3xl", "font-black", "tracking-tight", "text-foreground", "md:text-5xl"], "children": []},
               {"key": "problem-copy", "type": "container", "classes": ["flex", "max-w-[65ch]", "flex-col", "gap-5", "text-lg", "leading-relaxed", "text-foreground"], "children": [
         ...
         },
         {
           "key": "sales-mechanism",
           "type": "section",
           "classes": ["bg-muted", "px-4", "py-14", "font-sans", "text-foreground", "md:py-20"],
           "children": [
             {"key": "mechanism-wrap", "type": "container", "classes": ["mx-auto", "grid", "max-w-6xl", "gap-10", "items-start", "md:grid-cols-[0.9fr_1.1fr]"], "children": [
               {"key": "mechanism-copy", "type": "container", "classes": ["flex", "max-w-[65ch]", "flex-col", "gap-5"], "children": [
                 {"key": "mechanism-heading", "type": "heading", "tag": "h2", "text": "A launch system ordered by buyer commitment", "classes": ["text-3xl", "font-black", "tracking-tight", "text-foreground", "md:text-5xl"], "children": []},
                 {"key": "mechanism-text", "type": "text", "tag": "p", "text": "You build the moments in the order a buyer experiences them: belief, decision, payment, access, and next action.", "classes": ["text-lg", "leading-relaxed", "text-foreground"], "children": []}
               ]},
               {"key": "mechanism-flow", "type": "container", "classes": ["grid", "gap-4"], "children": [
                 {"key": "mechanism-1", "type": "container", "classes": ["rounded-2xl", "bg-card", "p-5"], "children": [
                   {"key": "mechanism-1-heading", "type": "heading", "tag": "h3", "text": "Belief", "classes": ["text-2xl", "font-black", "tracking-tight", "text-foreground"], "children": []},
                   {"key": "mechanism-1-copy", "type": "text", "tag": "p", "text": "Sharpen the claim until the visitor can repeat it.", "classes": ["mt-2", "text-base", "leading-relaxed", "text-foreground"], "children": []}
                 ]},
                 {"key": "mechanism-2", "type": "container", "classes": ["rounded-2xl", "bg-primary", "p-5", "text-primary-foreground"], "children": [
                   ...
                   {"key": "mechanism-2-copy", "type": "text", "tag": "p", "text": "Make the Offer stack concrete, scoped, and safe.", "classes": ["mt-2", "text-base", "leading-relaxed", "text-primary-foreground"], "children": []}
                 ]},
                 {"key": "mechanism-3", "type": "container", "classes": ["rounded-2xl", "bg-card", "p-5"], "children": [
                   {"key": "mechanism-3-heading", "type": "heading", "tag": "h3", "text": "Payment", "classes": ["text-2xl", "font-black", "tracking-tight", "text-foreground"], "children": []},
                   {"key": "mechanism-3-copy", "type": "text", "tag": "p", "text": "Remove Checkout uncertainty and keep the buyer moving.", "classes": ["mt-2", "text-base", "leading-relaxed", "text-foreground"], "children": []}
                 ]}
               ]}
             ]}
           ]
         },
         {
           ...
           "classes": ["bg-background", "px-4", "py-14", "font-sans", "text-foreground", "md:py-20"],
           "children": [
             {"key": "benefits-proof-wrap", "type": "container", "classes": ["mx-auto", "grid", "max-w-6xl", "gap-10", "items-start", "md:grid-cols-[1.05fr_0.95fr]"], "children": [
               {"key": "benefit-stack", "type": "container", "classes": ["grid", "gap-6"], "children": [
                 {"key": "benefit-heading", "type": "heading", "tag": "h2", "text": "What changes after the build", "classes": ["text-3xl", "font-black", "tracking-tight", "text-foreground", "md:text-5xl"], "children": []},
                 {"key": "benefit-1", "type": "container", "classes": ["grid", "gap-2", "rounded-2xl", "bg-muted", "p-5", "md:grid-cols-[11ch_1fr]"], "children": [
                   {"key": "benefit-1-label", "type": "text", "tag": "p", "text": "Offer", "classes": ["text-base", "font-black", "text-primary"], "children": []},
                   {"key": "benefit-1-copy", "type": "text", "tag": "p", "text": "You can explain what is included, who it is for, and why buying now makes sense.", "classes": ["text-base", "leading-relaxed", "text-foreground"], "children": []}
                 ]},
                 {"key": "benefit-2", "type": "container", "classes": ["grid", "gap-2", "rounded-2xl", "bg-muted", "p-5", "md:grid-cols-[11ch_1fr]"], "children": [
                   {"key": "benefit-2-label", "type": "text", "tag": "p", "text": "Checkout", "classes": ["text-base", "font-black", "text-primary"], "children": []},
                   {"key": "benefit-2-copy", "type": "text", "tag": "p", "text": "The buyer sees the Order, bump, payment step, guarantee, and access expectation without friction.", "classes": ["text-base", "leading-relaxed", "text-foreground"], "children": []}
                 ]},
                 {"key": "benefit-3", "type": "container", "classes": ["grid", "gap-2", "rounded-2xl", "bg-muted", "p-5", "md:grid-cols-[11ch_1fr]"], "children": [
                   {"key": "benefit-3-label", "type": "text", "tag": "p", "text": "Review", "classes": ["text-base", "font-black", "text-primary"], "children": []},
                   {"key": "benefit-3-copy", "type": "text", "tag": "p", "text": "You know which revenue signal to improve next instead of relaunching from scratch.", "classes": ["text-base", "leading-relaxed", "text-foreground"], "children": []}
                 ]}
               ]},
               {"key": "proof-panel", "type": "container", "classes": ["rounded-2xl", "bg-card", "p-6", "shadow-elevated", "md:p-8"], "children": [
                 {"key": "proof-quote", "type": "quote", "text": "The first time I knew exactly what to build next, the whole launch got calmer.", "classes": ["text-3xl", "font-black", "leading-tight", "tracking-tight", "text-foreground"], "children": []},
                 {"key": "proof-author", "type": "text", "tag": "p", "text": "Solo course operator after replacing a scattered launch plan with one measured Funnel path.", "classes": ["mt-5", "text-base", "font-semibold", "leading-relaxed", "text-foreground"], "children": []}
               ]}
             ]}
           ]
         },
         {
           ...
           "classes": ["bg-muted", "px-4", "py-14", "font-sans", "text-foreground", "md:py-20"],
           "children": [
             {"key": "offer-wrap", "type": "container", "classes": ["mx-auto", "grid", "max-w-6xl", "gap-8", "items-stretch", "md:grid-cols-[0.78fr_1.22fr]"], "children": [
               {"key": "offer-includes", "type": "container", "classes": ["rounded-2xl", "bg-card", "p-6", "md:p-8"], "children": [
                 ...
                 {"key": "offer-includes-list", "type": "container", "classes": ["mt-6", "grid", "gap-3", "text-base", "leading-relaxed", "text-foreground"], "children": [
               ...
               {"key": "offer-card", "type": "container", "classes": ["rounded-2xl", "bg-primary", "p-6", "text-primary-foreground", "shadow-elevated", "md:p-8"], "children": [
                 ...
                 {"key": "offer-copy", "type": "text", "tag": "p", "text": "Build the sales path in order, then improve it from revenue signals instead of guesswork.", "classes": ["mt-4", "max-w-[65ch]", "text-lg", "leading-relaxed", "text-primary-foreground"], "children": []},
                 ...
                 {"key": "offer-guarantee", "type": "text", "tag": "p", "text": "30-day guarantee. Instant access after Checkout.", "classes": ["mt-4", "text-base", "font-bold", "leading-relaxed", "text-primary-foreground"], "children": []},
         ...
         },
         {
           ...
           "classes": ["bg-background", "px-4", "py-14", "font-sans", "text-foreground", "md:py-20"],
           "children": [
             {"key": "faq-wrap", "type": "container", "classes": ["mx-auto", "grid", "max-w-4xl", "gap-8"], "children": [
               {"key": "faq-heading", "type": "heading", "tag": "h2", "text": "Questions before you enroll", "classes": ["text-3xl", "font-black", "tracking-tight", "text-foreground", "md:text-5xl"], "children": []},
               {"key": "faq-list", "type": "container", "classes": ["grid", "gap-5", "text-base", "leading-relaxed", "text-foreground", "md:text-lg"], "children": [
       ...
       "elements": [
         {
           "key": "checkout-page",
           "type": "section",
           "classes": ["bg-muted", "px-4", "py-12", "md:py-20", "font-sans", "text-foreground", "antialiased"],
           "children": [
             {
               "key": "checkout-wrap",
               "type": "container",
               ...
               "children": [
                 {"key": "checkout-heading", "type": "heading", "tag": "h1", "text": "Complete enrollment", "classes": ["text-center", "text-4xl", "font-black", "tracking-tight", "text-foreground", "md:text-5xl"], "children": []},
                 {"key": "checkout-subhead", "type": "text", "tag": "p", "text": "Secure Checkout. Instant access after your Order is complete.", "classes": ["mx-auto", "mt-4", "max-w-[65ch]", "text-center", "text-lg", "leading-relaxed", "text-foreground"], "children": []},
                 {
                   "key": "checkout-form",
                   "type": "checkout",
                   "classes": ["mt-10", "grid", "gap-6", "items-start", "md:grid-cols-[minmax(0,1.25fr)_minmax(320px,0.75fr)]"],
                   ...
                   "children": [
                     {"key": "checkout-billing", "type": "container", "classes": ["rounded-2xl", "bg-card", "p-6", "shadow-elevated", "md:p-8"], "children": [
                       {"key": "billing-heading", "type": "heading", "tag": "h2", "text": "Billing details", "classes": ["text-2xl", "font-black", "tracking-tight", "text-foreground"], "children": []},
                     ...
                     {"key": "checkout-sidebar", "type": "container", "classes": ["rounded-2xl", "bg-card", "p-6", "shadow-elevated", "md:sticky", "md:top-6"], "children": [
                       ...
                       {"key": "checkout-trust", "type": "text", "tag": "p", "text": "30-day guarantee. Secure payment. Instant access.", "classes": ["mt-4", "text-sm", "leading-relaxed", "text-foreground"], "children": []}
                     ]}
                   ]
                 }
               ]
